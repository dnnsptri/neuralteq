          ...
          <FadeInUp delay={0.0}>
            <BodyText className="space-y-6 md:space-y-8 mb-8">
              ...
              <div className="space-y-8">
                <div>
                  <h3 className="text-xl font-semibold mb-2">For more specific information about subnets and how to trade them, feel free to check these links:</h3>
                  <ul className="list-disc pl-6 space-y-2">
                    <li>Our earlier post to learn more about the different subnets and their AI use cases: <Link href="https://x.com/neuralteq/status/1899839775059718502" className="underline text-[#EF6C00] hover:text-[#ECFBFA] transition-colors duration-200" target="_blank" rel="noopener noreferrer">https://x.com/neuralteq/status/1899839775059718502</Link></li>
                    <li>The TAO-Validator page for a weekly round-up on all the subnet developments, this is the most recent one: <Link href="https://x.com/TAO_ValidatorX/status/1916400260051505526" className="underline text-[#EF6C00] hover:text-[#ECFBFA] transition-colors duration-200" target="_blank" rel="noopener noreferrer">https://x.com/TAO_ValidatorX/status/1916400260051505526</Link></li>
                    <li>The TAO-Validator platform where you can see dTAO prices and where you can swap in and out of subnets: <Link href="https://t.co/dYXmtUTt1l" className="underline text-[#EF6C00] hover:text-[#ECFBFA] transition-colors duration-200" target="_blank" rel="noopener noreferrer">https://t.co/dYXmtUTt1l</Link></li>
                  </ul>
                </div>
              </div>
